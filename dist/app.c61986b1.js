...
var View = /** @class */function () {
  function View(containerId, template) {
    ...
    if (!containerElement) {
      throw '最上位コンテイナーが存在しなく、UIの進行ができませんでした。';
    }
